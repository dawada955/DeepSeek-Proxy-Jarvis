(() => {
    ...
    o = {
      ...
      77983: function (e, t, r) {
        ...
        e.exports = function (e) {
          ...
          if (k && !(this === p && a(k)))
            for (
              r = y ? new this() : [], g = (v = f(w, k)).next;
              !(d = i(g, v)).done;
              x++
            )
              ((m = R ? s(v, S, [d.value, x], !0) : d.value), c(r, x, m));
          else
            for (t = h(w), r = y ? new this(t) : p(t); t > x; x++)
              ((m = R ? S(w[x], x) : w[x]), c(r, x, m));
          return ((r.length = x), r);
        };
      },
      59848: function (e, t, r) {
        var n = r(47422),
          i = r(60104);
      ...
      13716: function (e, t, r) {
        var n = r(91624);
        e.exports = /ipad|iphone|ipod/i.test(n) && "undefined" != typeof Pebble;
      },
      12671: function (e, t, r) {
        var n = r(91624);
        e.exports = /(?:ipad|iphone|ipod).*applewebkit/i.test(n);
      },
      64405: function (e, t, r) {
        var n = r(91624);
      ...
      91429: function (e, t, r) {
        ...
        e.exports = function (e, t, r) {
          var g,
            ...
            O = n(t, k),
            E = function (e) {
              return (g && l(g, "normal", e), new d(!0, e));
            },
            j = function (e) {
              return x
                ? (o(e), L ? O(e[0], e[1], E) : O(e[0], e[1]))
                : L
                  ? O(e, E)
                  : O(e);
            };
          if (P) g = e.iterator;
            ...
            if (!(m = f(e))) throw new p(s(e) + " is not iterable");
            if (a(m)) {
              for (w = 0, y = u(e); y > w; w++)
                if ((b = j(e[w])) && h(v, b)) return b;
              return new d(!1);
            }
            g = c(e, m);
          }
          for (S = P ? e.next : g.next; !(R = i(S, g)).done; ) {
            try {
              b = j(R.value);
            } catch (e) {
              l(g, "throw", e);
      ...
      53138: function (e, t, r) {
        ...
        if (!S) {
          var R = new l(),
            k = function () {
              var e, t;
              for (g && (e = y.domain) && e.exit(); (t = R.get()); )
                try {
                  t();
                } catch (e) {
                  throw (R.head && n(), e);
          ...
          (p || g || v || !m || !w
            ...
            : ((i = !0),
              (o = w.createTextNode("")),
              new m(k).observe(o, { characterData: !0 }),
              (n = function () {
                o.data = i = !i;
              })),
            (S = function (e) {
      ...
      35116: function (e, t, r) {
        ...
        e.exports =
          ...
          s(function () {
            ...
            ? function (e, t) {
                for (
                  var r = c(e), i = arguments.length, s = 1, l = u.f, p = h.f;
                  i > s;
                )
                  for (
                    var v,
      ...
      73250: function (e, t, r) {
        var n = r(23741),
          ...
          y = function (e, t, r) {
            var n = 0;
            for (e = r ? h(e / 700) : e >> 1, e += h(e / t); e > 455; )
              ((e = h(e / 35)), (n += 36));
          ...
          b = function (e) {
            ...
            for (d && p(n, "-"); v < i; ) {
              ...
              for (t = 0; t < e.length; t++)
                (r = e[t]) >= o && r < g && (g = r);
              var b = v + 1;
              if (g - o > h((0x7fffffff - u) / b)) throw new a(s);
              for (u += (g - o) * b, o = g, t = 0; t < e.length; t++) {
                if ((r = e[t]) < o && ++u > 0x7fffffff) throw new a(s);
                if (r === o) {
                  for (var S = u, R = 36; ; ) {
                    var k = R <= f ? 1 : R >= f + 26 ? 26 : R - f;
                    if (S < k) break;
                    var x = S - k,
                      P = 36 - k;
                    (p(n, c(w(k + (x % P)))), (S = h(x / P)), (R += 36));
                  }
                  (p(n, c(w(S))), (f = y(u, b, v === d)), (u = 0), v++);
                }
              }
              (u++, o++);
            }
            ...
            : R && R.now
              ...
              : x && !m
                ...
                : a.addEventListener &&
                    ...
                    "file:" !== n.protocol &&
                    !l(C)
                  ? ((i = C), a.addEventListener("message", _, !1))
                  : (i =
                      O in v("script")
                        ? function (e) {
      ...
      96932: function (e, t, r) {
        var n = r(66505),
          ...
          u = r(91429);
        n(
          { target: "Promise", stat: !0, forced: r(40456) },
          {
            all: function (e) {
              var t = this,
                r = s.f(t),
      ...
      17760: function (e, t, r) {
        var n = r(66505),
          i = r(2922),
          o = r(51569).CONSTRUCTOR,
          s = r(17825),
          a = r(68592),
          u = r(46768),
          h = r(33689),
        ...
        if (
          ...
          c.catch !== f && h(c, "catch", f, { unsafe: !0 });
        }
      },
      23191: function (e, t, r) {
        var n,
          i,
          o,
          s,
          ...
          G = function (e, t) {
            ...
            try {
              a
                ? (s || (2 === t.rejection && Y(t), (t.rejection = 1)),
                  !0 === a
                    ? (r = o)
                    : (c && c.enter(), (r = a(o)), c && (c.exit(), (i = !0))),
                  r === e.promise
                    ? h(new N("Promise-chain cycle"))
                    : (n = J(r))
                      ? f(n, r, u, h)
                      : u(r))
                : h(o);
          ...
          Q = function (e, t, r) {
            ...
            (W
              ...
              !C && (i = c["on" + e])
                ? i(n)
                : e === $ && k("Unhandled promise rejection", r));
          },
          K = function (e) {
            f(S, c, function () {
              var t,
              ...
              if (
                X(e) &&
                ((t = x(function () {
                  h ? M.emit("unhandledRejection", n, r) : Q($, r, n);
                })),
                (e.rejection = h || X(e) ? 2 : 1),
                t.error)
              )
                throw t.value;
            });
        ...
        if (
          ...
          (E.f = F =
            function (e) {
              return e === H || e === o ? new i(e) : D(e);
            }),
          !u && m(L) && B !== Object.prototype)
        ) {
          ((s = B.then),
            T ||
              l(
        ...
        (a(
          { global: !0, constructor: !0, wrap: !0, forced: _ },
          { Promise: H },
        ),
          d(H, j, !1, !0),
          v(j));
      },
      81237: function (e, t, r) {
        (r(23191), r(96932), r(17760), r(63458), r(52516), r(8655));
      },
      63458: function (e, t, r) {
        var n = r(66505),
          i = r(94412),
          o = r(63261),
          s = r(76840),
        ...
        n(
          { target: "Promise", stat: !0, forced: r(40456) },
          {
            race: function (e) {
              ...
              return (h.error && n(h.value), r.promise);
            },
          },
        );
      },
      52516: function (e, t, r) {
        var n = r(66505),
          i = r(76840);
        n(
          { target: "Promise", stat: !0, forced: r(51569).CONSTRUCTOR },
          {
            reject: function (e) {
              var t = i.f(this);
      ...
      8655: function (e, t, r) {
        ...
        n(
          ...
          {
            resolve: function (e) {
              return u(c && this === h ? s : this, e);
            },
          },
        );
      },
      57340: function (e, t, r) {
        var n = r(66505),
          i = r(23741),
          o = r(25263),
          s = RangeError,
            ...
            fromCodePoint: function (e) {
              for (var t, r = [], n = arguments.length, i = 0; n > i; ) {
                if (((t = +arguments[i++]), o(t, 1114111) !== t))
                  throw new s(t + " is not a valid code point");
                r[i] =
                  t < 65536
                    ? a(t)
      ...
      79487: function (e, t, r) {
        ...
        s(
          ...
          "String",
          function (e) {
            h(this, { type: u, string: i(e), index: 0 });
          },
          function () {
            var e,
              t = c(this),
      ...
      18062: function (e, t, r) {
        r(49774)("Uint8", function (e) {
      ...
      60643: function (e, t, r) {
        ...
        var n = r(66505),
          ...
          ed = v(
            function (e, t) {
              B(this, { type: A, target: H(e).entries, index: 0, kind: t });
            },
            q,
            function () {
              var e = I(this),
                ...
                r = e.index++;
              if (!t || r >= t.length)
                return ((e.target = null), E(void 0, !0));
              var n = t[r];
              switch (e.kind) {
                case "keys":
                  return E(n.key, !1);
          ...
          parseObject: function (e) {
            ...
            if (c)
              for (r = (t = L(e, c)).next; !(n = a(r, t)).done; ) {
                if (
                  (s = a((o = (i = L(R(n.value))).next), i)).done ||
                  (u = a(o, i)).done ||
                  !a(o, i).done
                )
                  throw new W("Expected sequence with length 2");
                X(h, { key: x(s.value), value: x(u.value) });
              }
            else for (var f in e) y(e, f) && X(h, { key: f, value: x(e[f]) });
          },
          parseQuery: function (e) {
            if (e)
              for (
                var t, r, n = this.entries, i = et(e, "&"), o = 0;
                o < i.length;
              )
                (t = i[o++]).length &&
                  X(n, { key: eh(Z((r = et(t, "=")))), value: eh(K(r, "=")) });
          },
          serialize: function () {
            for (var e, t = this.entries, r = [], n = 0; n < t.length; )
              X(r, ep((e = t[n++]).key) + "=" + ep(e.value));
            return K(r, "&");
          },
          update: function () {
        ...
        if (
          (p(
            em,
            {
              ...
              delete: function (e) {
                for (
                  ...
                  if (u.key === i && (void 0 === s || u.value === s)) {
                    if ((ee(n, a, 1), void 0 !== s)) break;
                  } else a++;
                }
                (h || (this.size = n.length), t.updateURL());
              },
              get: function (e) {
                var t = H(this).entries;
                j(arguments.length, 1);
                for (var r = x(e), n = 0; n < t.length; n++)
              ...
              getAll: function (e) {
                var t = H(this).entries;
                j(arguments.length, 1);
                for (var r = x(e), n = [], i = 0; i < t.length; i++)
              ...
              set: function (e, t) {
                ...
                j(arguments.length, 1);
                for (
                  var i = n.entries, o = !1, s = x(e), a = x(t), u = 0;
                  u < i.length;
                  u++
                )
                  (r = i[u]).key === s &&
                    (o ? ee(i, u--, 1) : ((o = !0), (r.value = a)));
                (o || X(i, { key: s, value: a }),
          ...
          f(em, T, em.entries, { name: "entries" }),
          f(
            em,
            "toString",
            function () {
              ...
              if (k(e)) {
                ...
                if (S(r) === q)
                  return (
                    ...
                    P(e, { body: U(0, x(r)), headers: U(0, t) })
                  );
              }
              return e;
            };
          if (
            ...
            var eS = function (e) {
              return (
                m(this, F),
                new z(e, arguments.length > 1 ? eb(arguments[1]) : {})
              );
            };
            ((F.constructor = eS),
              (eS.prototype = F),
        ...
        e.exports = { URLSearchParams: eg, getState: H };
      },
      43536: function (e, t, r) {
        var n = r(33689),
          i = r(23741),
          o = r(50854),
          s = r(17553),
            ...
            n(
              ...
              function (e) {
                ...
                (f(this, function (e, t) {
                  ...
                  s(r, 1));
                for (
                  var a = o(e), u = o(n), p = 0, d = 0, v = !1, g = i.length;
                  p < g;
                )
                  ((t = i[p++]),
                    v || t.key === a ? ((v = !0), c(this, t.key)) : d++);
                for (; d < g; )
                  ((t = i[d++]).key !== a || t.value !== u) &&
                    h(this, t.key, t.value);
              },
              { enumerable: !0, unsafe: !0 },
            ));
      },
      95743: function (e, t, r) {
        var n = r(33689),
          i = r(23741),
          o = r(50854),
          s = r(17553),
      ...
      44947: function (e, t, r) {
        ...
        var n,
          ...
          es = function (e) {
            ...
            for (n = 0, r = []; n < t; n++) {
              ...
              if (
                ...
                i.length > 1 &&
                  "0" === T(i, 0) &&
                  ((o = q(X, i) ? 16 : 8), (i = F(i, 8 === o ? 1 : 2))),
                "" === i)
              )
                s = 0;
              else {
                if (!q(10 === o ? Z : 8 === o ? Y : ee, i)) return e;
                s = j(i, o);
              }
              I(r, s);
            }
          ...
          ea = function (e) {
            ...
            if (null !== c)
              for (s = h - c, h = 7; 0 !== h && s > 0; )
                ((a = u[h]), (u[h--] = u[c + s - 1]), (u[c + --s] = a));
            else if (8 !== h) return;
            return u;
          },
          eu = function (e) {
          ...
          ev = { ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443 },
          eg = function (e, t) {
            var r;
            return (
              2 === e.length &&
          ...
          eN = function (e, t, r) {
            ...
            if (t) {
              ...
              if (
                (void 0 !== r && (n = new eN(r, !0)),
                (i = this.parse(s, null, n)))
              )
                throw new E(i);
              ((o = L(new U())).bindURL(this), (this.searchParams = o));
            }
          };
        eN.prototype = {
          type: "URL",
            ...
            for (
              ...
              switch (((f = c[o]), i)) {
                ...
                case eL:
                  if ("@" === f) {
                    (a && (s = "%40" + s), (a = !0), (l = v(s)));
                    for (var c, f, l, d, m, w, b = 0; b < l.length; b++) {
                      var S = l[b];
                      if (":" === S && !h) {
                        h = !0;
                        continue;
                      ...
                      var R = ed(S, ep);
                      h ? (this.password += R) : (this.username += R);
                    }
                    s = "";
                  } else if (
                    f === n ||
                  ...
                  if (":" !== f || u)
                    if (
                      ...
                      if (
                        ...
                        return;
                      if ((d = this.parseHost(s))) return d;
                      if (((s = ""), (i = eq), t)) return;
                      continue;
                    } else
                      ("[" === f ? (u = !0) : "]" === f && (u = !1), (s += f));
                ...
                case ej:
                  if (q(K, f)) s += f;
                    ...
                    if ("" !== s) {
                      ...
                      if (k > 65535) return G;
                      ((this.port =
                        this.isSpecial() && k === ev[this.scheme] ? null : k),
                        (s = ""));
                    }
                    if (t) return;
                    i = eq;
          ...
          parseHost: function (e) {
            var t, r, n;
            if ("[" === T(e, 0)) {
              if ("]" !== T(e, e.length - 1) || !(t = ea(F(e, 1, -1))))
                return J;
              this.host = t;
            } else if (this.isSpecial()) {
              if (q(et, (e = w(e))) || null === (t = es(e))) return J;
              this.host = t;
            } else {
              if (q(er, e)) return J;
              for (n = 0, t = "", r = v(e); n < r.length; n++)
                t += ed(r[n], ec);
              this.host = t;
            }
          },
          ...
          setUsername: function (e) {
            ...
            if (!this.cannotHaveUsernamePasswordPort()) {
              this.username = "";
              for (var r = 0; r < t.length; r++) this.username += ed(t[r], ep);
            }
          },
          ...
          setPassword: function (e) {
            ...
            if (!this.cannotHaveUsernamePasswordPort()) {
              this.password = "";
              for (var r = 0; r < t.length; r++) this.password += ed(t[r], ep);
            }
          },
          getHost: function () {
            var e = this.host,
              t = this.port;
            return null === e ? "" : null === t ? eh(e) : eh(e) + ":" + t;
          },
          setHost: function (e) {
          ...
          setPort: function (e) {
            this.cannotHaveUsernamePasswordPort() ||
              ("" === (e = y(e)) ? (this.port = null) : this.parse(e, ej));
          },
        ...
        if (
          (o &&
            (f(eM, "href", eF("serialize", "setHref")),
            f(eM, "origin", eF("getOrigin")),
            f(eM, "protocol", eF("getProtocol", "setProtocol")),
            f(eM, "username", eF("getUsername", "setUsername")),
            f(eM, "password", eF("getPassword", "setPassword")),
            f(eM, "host", eF("getHost", "setHost")),
            f(eM, "hostname", eF("getHostname", "setHostname")),
            f(eM, "port", eF("getPort", "setPort")),
            f(eM, "pathname", eF("getPathname", "setPathname")),
            f(eM, "search", eF("getSearch", "setSearch")),
            f(eM, "searchParams", eF("getSearchParams")),
            f(eM, "hash", eF("getHash", "setHash"))),
          c(
            eM,
            "toJSON",
            function () {
          ...
          (eD && c(ez, "createObjectURL", u(eD, O)),
            eW && c(ez, "revokeObjectURL", u(eW, O)));
        }
        (b(ez, "URL"),
          i(
            { global: !0, constructor: !0, forced: !s, sham: !o },
            { URL: ez },
          ));
      },
      14281: function (e, t, r) {
        r(44947);
      },
      18009: function (e, t, r) {
        var n = r(66505),
          i = r(94412);
        n(
      ...
      81213: function (e, t, r) {
        ...
        function h(e, t, r) {
          ...
          if (c !== n) {
            (0 !== c && (e = e.slice(c)),
              (o = r(o, n, (n = c + 3 * e.length), 1) >>> 0));
            let t = u(e, s().subarray(o + c, o + n));
            ((c += t.written), (o = r(o, n, c, 1) >>> 0));
          }
          return ((i = c), o);
        }
        let c = null;
        ...
        async function d(e) {
          ...
          (void 0 !== e &&
            ...
            void 0 === e && (e = new URL(r(36761), r.b)));
          let i = (((t = {}).wbg = {}), t);
          ("string" == typeof e ||
            ("function" == typeof Request && e instanceof Request) ||
            ("function" == typeof URL && e instanceof URL)) &&
            (e = fetch(e));
          let { instance: s, module: a } = await p(await e, i);
          return (
            (n = s.exports),
            (d.__wbindgen_wasm_module = a),
            (c = null),
            (o = null),
            n
          );
        ...
        onmessage = (e) => {
          ...
          v.then(() => {
            ...
            postMessage({ type: "pow-error", error: e });
          });
        };
      },
    },
  ...
  ((a.m = o),
    (a.x = () => {
      var e = a.O(void 0, ["60816"], function () {
        return a(81213);
      });
      return a.O(e);
    }),
    ...
    (a.O = (t, r, n, i) => {
      ...
      for (var s = 1 / 0, o = 0; o < e.length; o++) {
        for (var [r, n, i] = e[o], u = !0, h = 0; h < r.length; h++)
          (!1 & i || s >= i) && Object.keys(a.O).every((e) => a.O[e](r[h]))
            ? r.splice(h--, 1)
            : ((u = !1), i < s && (s = i));
        if (u) {
          e.splice(o--, 1);
    ...
    (a.p = "https://fe-static.deepseek.com/chat/"),
    (a.rv = () => "1.5.8"),
    (t = a.x),
    (a.x = () => a.e("60816").then(t)),
    (a.b = self.location + "/../../"),
    (r = { 33614: 1 }),
    (a.f.i = (e, t) => {
      r[e] || importScripts(a.p + a.u(e));
    }),
    (i = (n = self.webpackChunk_deepseek_chat =
      self.webpackChunk_deepseek_chat || []).push.bind(n)),
    (n.push = (e) => {
      var [t, n, o] = e;
      for (var s in n) a.o(n, s) && (a.m[s] = n[s]);
      for (o && o(a); t.length; ) r[t.pop()] = 1;
      i(e);
    }),
    (a.ruid = "bundler=rspack@1.5.8"),
    a.x());
})();
